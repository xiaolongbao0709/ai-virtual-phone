...
const MEDIA_DIRECTIVE_RE = /\[(?:代付请求|音乐分享|语音条|表情包|照片|红包|转账|位置|名片|音乐|礼物|线下邀约|更改地点|修改地点|变更地点|提前到达|我已到达|到达现场|提前抵达|强行动身|强行赴约|霸道奔赴|执意赶来|执意奔赴|封禁线下|线下封禁|封锁线下|线下封锁)\s*[:：]?[^\]\r\n]*\]|\[(?:提醒赴约|再次邀约|重新邀约|提前到达|我已到达|到达现场|提前抵达|解除封禁|解除线下封禁|解封线下|解除封锁|解除线下封锁|线下解封|取消邀约|撤销邀约|收回邀约|取消赴约|撤销赴约)\s*[:：]?[^\]\r\n]*\]/g;
const INCOMPLETE_MEDIA_DIRECTIVE_RE = /\[(?:代付请求|音乐分享|语音条|表情包|照片|红包|转账|位置|名片|音乐|礼物|线下邀约|更改地点|修改地点|变更地点|提前到达|我已到达|到达现场|提前抵达|强行动身|强行赴约|霸道奔赴|执意赶来|执意奔赴|封禁线下|线下封禁|封锁线下|线下封锁)\s*[:：]?[^\]\r\n]*$|\[(?:提醒赴约|再次邀约|重新邀约|提前到达|我已到达|到达现场|提前抵达|解除封禁|解除线下封禁|解封线下|解除封锁|解除线下封锁|线下解封|取消邀约|撤销邀约|收回邀约|取消赴约|撤销赴约)?$/g;
